    ...
    */
    "list" => [
            ...
            [
                "name"        => "HRM",
                "route"       => "hrm",
                "link"        => '/admin/hrm/dashboard',
                "permissions" => ["_superadmin", '_hrm-admin'],
            ],
//            [
//                "name" => "",
//                "route" => "hrm.listpayrolls",
//                "link" => '/admin/hrm/listpayrolls',
//                "permissions" => ["_superadmin", "_hrm-admin"]
//            ],
//            [
//                "name" => "",
//                "route" => "hrm.addpayroll",
//                "link" => '/admin/hrm/addpayroll',
//                "permissions" => ["_superadmin", "_hrm-admin"]
//            ],
//            [
//                "name" => "",
//                "route" => "hrm.editpayroll",
//                "link" => '/admin/hrm/editpayroll',
//                "permissions" => ["_superadmin", "_hrm-admin"]
//            ],
            ...
            [
                "name" => "",
                "route" => "user",
                "link" => '/hrm/userpayrolls',
                "permissions" => ["_superadmin", '_hrm-user']
            ],
            [
                "name" => "",
                "route" => "user",
                "link" => '/hrm/userpayroll',
                "permissions" => ["_superadmin","_hrm-user"]
            ],
            ...
            [
                 ...
                 */
                "skip_permissions" => ["users.selfprofile.edit", "users.profile.edit", "users.profile.addfield", "users.profile.deletefield", "users.profile.changeavatar"]
            ],
            [
                    "name"        => "Groups",
                    "route"       => "groups",
            ...
            [
                ...
                "name" => "",
                "route" => "avatarprofile",
                "link" => '/admin/users/profile/avatar',
                "permissions" => ["_superadmin", "_profile-change-avatar"]
            ],
    ]
];
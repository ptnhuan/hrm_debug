...
use App\Http\Authentication\Sentry\Payrolls\NameRequiredException;

use App\Http\Authentication\Sentry\Payrolls\PayrollInterface;
use Illuminate\Database\Eloquent\Model;

class Payroll extends Model implements PayrollInterface {
	 ...
	 *
	 * @return bool
	 * @throws App\Http\Authentication\Sentry\Payrolls\NameRequiredException
	 * @throws App\Http\Authentication\Sentry\Payrolls\PayrollExistsException
	 */
	public function validate()
	{
		// Check if name field was passed
		if ( ! $name = $this->hrm_payroll_title)
		{
